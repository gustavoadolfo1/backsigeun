...
$this->Cell(190, $_h, "CONSOLIDADO DE INGRESOS x CONCEPTO", 0, 0, "C");
...
$this->Cell(97, $_h, "Concepto", 1, 0, "C", 1);
$this->Cell(30, $_h, "Código", 1, 0, "C", 1);
$this->Cell(20, $_h, "Clasificador", 1, 0, "C", 1);
$this->Cell(10, $_h, "#", 1, 0, "C", 1);
$this->Cell(20, $_h, "Importe", 1, 0, "C", 1);

if ($this->PageNo()*1 > 1 ) { $this->axisY += 7;  $this->fnSetAxes( $this->axisY, $this->axisX ); }