...
$this->Cell(273, $_h, "REGISTRO CONCEPTOS DE INGRESO x CLASIFICADOR PRESUPUESTAL", 0, 0, "C");

$this->axisY += 6;  $this->fnSetAxes( $this->axisY, $this->axisX );
$this->SetFont("helvetica", "B", 7);
$this->Cell(18, $_h, " U. Organica:", "", 0, "L");
$this->SetFont("helvetica", "", 7);
$this->Cell(130, $_h, $GLOBALS["_param"]->get("_DepenNombre"), "", 0, "L");
