...
$this->Cell(280, $_h, "RESUMEN DE INGRESOS POR DOCUMENTO", 0, 0, "C");
...
$this->Cell(14, $_h, "Documento", 1, 0, "C", 1);
//$this->Cell(16, $_h, "Fecha", 1, 0, "C", 1);
$this->Cell(14, $_h, "Importe", 1, 0, "C", 1);
$_col = 0;
foreach ($GLOBALS["_aedg"] as $row){ $_col++;
    $this->Cell(13, $_h, $row["cEspeDetCodigo"], 1, 0, "C", 1);
}

$_col = (count($GLOBALS["_aedg"]) <= 7 ? 7 : 18)-$_col;
for ($i = 0; $i < $_col; $i++) {
    $this->Cell(13, $_h, "", 1, 0, "C", 1);
}
//$this->setXY(14,60);
