...
class DocumentosTramite extends Controller
{
    /**
     * 
     * 
    ...
    //public function getResult($skip,$top,$inlinecount,$format){
     public function getResult(Request $request){
       ...
       // $respuesta = DB::select('EXECUTE tram.Sp_SEL_CiclosAcademicosMatricXcEstudCodUniv ?', $data);
         $datos = \DB::select("EXEC pat.Sp_SEL_Documento_resepcionados ?,?,?",array( $skip,$top,$value_filtro_cDocAdqNro));
     // print_r($datos)
         // $total=45;
          $total=\DB::select("EXEC pat.Sp_COUNT_Documento_resepcionados ?",array($value_filtro_cDocAdqNro));
          $data = [       
