<?php namespace App\Packages\Maatwebsite\Maatwebsite\Excel;

use PHPExcel_Settings;
use PHPExcel_Shared_Font;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Readers\Html;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Classes\Cache;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Classes\PHPExcel;
use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Response;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Parsers\CssParser;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Parsers\ViewParser;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Classes\FormatIdentifier;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Readers\LaravelExcelReader;
use App\Packages\Maatwebsite\Maatwebsite\Excel\Writers\LaravelExcelWriter;
...
class ExcelServiceProvider extends ServiceProvider {
    ...
    protected function bindExcel()
    {
        ...
        $this->app->singleton('laravelExcel', function ($app)
        {
            $excel = new Excel(
                $app['phpexcel'],
                $app['excel.reader'],
        ...
        $this->app->alias('laravelExcel', Excel::class);
    }
