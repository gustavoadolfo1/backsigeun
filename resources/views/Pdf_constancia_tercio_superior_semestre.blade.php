...
<div id="header_h4"><p><i>"{{$anio}}"</i></p></div>  
        ...
        <div style="margin:  0px 80px 0px 80px">
            <div style=" font-size: 22px;  text-align: center;"><strong><br>&nbsp;CONSTANCIA DE TERCIO SUPERIOR<br>&nbsp;<font size="18px">C.TS. N° 000{{$nombre[0]->cDocNumDoc}}-{{$nombre[0]->iDocAnioEmision}}</font><br>
&nbsp;</strong></div>
