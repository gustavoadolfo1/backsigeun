...
<head>
    ...
    <title>CONSTANCIA DE QUINTO SUPERIOR INGRESANTES</title>
...
<div id="header_h4"><p><i>"{{$anio}}"</i></p></div>       
        ...
        <div style="margin:  00px 100px 0px 100px">
            <div style=" font-size: 22px;  text-align: center;"><strong><br>&nbsp;CONSTANCIA DE QUINTO SUPERIOR<br>PROMOCION DE INGRESANTES {{$certificado[0]->cSemestreIngreso}}<br>&nbsp;<font size="18px">C.TS.P.IGR.M N° 000{{$nombre[0]->cDocNumDoc}}</font><br>
&nbsp;</strong></div>
