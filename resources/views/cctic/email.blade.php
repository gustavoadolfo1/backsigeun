    ...
    <div class="container-body">
        <div class="content-container">
            <div class="header-email">
                <table id="wrapper">
                    <tr>
                        <td><img class="image-logo" src="http://www.unam.edu.pe/images/logo210x60.png" alt="logo unam" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="message-email">
                ...
                <p class="bottom-spacing light">{{$data->cCursoNombre}} {{$data->cModuloNombre}}</p>
                <p class="bottom-spacing light">⏰ Horario: <br>
            ...
            <div class="pre-footer-email">
                <p> ⚠️Recuerda que cuando el curso se aperture se te enviara nuevamente un correo electronico con
                    los
                    detalles de pago, y las fechas de la matricula.</p>
            </div>
