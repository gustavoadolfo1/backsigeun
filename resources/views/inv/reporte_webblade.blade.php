...
<br>
            ...
            <table width="100%" style="border: 1px solid #2B2E4A" cellspacing="0" cellpadding="3" border="1">
                ...
                <tr class="card-header" style="font-size:11px;background: #2B2E4A; color:white">
                    ...
                    <th width="5%" style="text-align:center"><strong>PRESUPUESTO</strong></th>
                    <th width="10%" style="text-align:center"><strong>EJECUTADO</strong></th>
                    <th width="10%" style="text-align:center"><strong>%</strong></th>

                    <th width="10%" style="text-align:center"><strong>OBSERVACION</strong></th>
                    <th width="10%" style="text-align:center"><strong>ESTADO</strong></th>
                    <th width="10%" style="text-align:center"><strong>FUENTE</strong></th>
                </tr>
                </thead>
                <tbody>
                ...
                <tr style="font-size: 10px">
                    ...
                    <td style="text-align: center;">{{ number_format(($a->nPresupuestoEjecucion), 2, '.', '') }}</td>
