        ...
        @if ($a->anyo <> $anyoAnt)
            ...
            @if ($anyoAnt <> '')
                <tr style="font-size: 10px; text-align: center">
                    ...
                    <td style="text-align: right;">{{ number_format(($totalSumGasto), 2, '.', '') }}</td>
                </tr>
                </tbody>
                </table>
                <br>
            ...
            @if ($a->iEstadoPropuesta <> $estadoPropuestaAnt)
                @switch($a->iEstadoPropuesta)
                    @case(0)
                    <h3 style="text-align:center"><strong>Gastos de Proyectos por Rubros por Año</strong></h3>
                    @break

                    @case(1)
                    <h3 style="text-align:center"><strong>Gastos de Propuestas de Proyectos por Rubros por Año</strong></h3>
                    @break
                @endswitch
            ...
            <table width="100%" style="border: 1px solid #2B2E4A" cellspacing="0" cellpadding="3" border="1">
                ...
                <tr style="font-size: 10px">
                    ...
                    <td style="text-align: right;">{{ number_format(($a->sumGasto), 2, '.', '') }}</td>
                </tr>
            @php
                $anyoAnt = $a->anyo;
