...
<table width="100%" style="border: 1px solid #2B2E4A" cellspacing="0" cellpadding="3" border="1">
    ...
    <tr style="font-size: 13px; text-align: center">
        <th width="100%" colspan="5" style="text-align:center"><strong></strong></th>
    </tr>
    <tr class="card-header" style="font-size:11px;background: #2B2E4A; color:white">
        <th width="2%" style="text-align:center"><strong>N°</strong></th>
        <th width="70%" style="text-align:center"><strong>PROYECTO</strong></th>

        <th width="9%" style="text-align:center"><strong>GENERAL</strong></th>
        <th width="10%" style="text-align:center"><strong>DISTRIBUIDO ITEMS</strong></th>
        <th width="10%" style="text-align:center"><strong>GASTADO</strong></th>
    ...
    @foreach($resumen as $index=>$a)
        <tr style="font-size: 10px">
            ...
            <td style="text-align: center;">{{ number_format(($a->nPresupuestoProyecto), 2, '.', '') }}</td>
